# src/models/database/mj_network.py - FIXED: Rename Relationship to NetworkRelationship
...
# =====================================================
# MODELS - FIXED: NetworkRelationship instead of Relationship
# =====================================================
...
# FIXED: Renamed Relationship to NetworkRelationship
class NetworkRelationship(Base):
    __tablename__ = "relationships_network"
    ...
    user = relationship("User", foreign_keys=[user_id], back_populates="user_network_relationships")
    friend = relationship("User", foreign_keys=[friend_user_id], back_populates="friend_network_relationships")
    
    # FIXED: Updated back_populates name
...
class MJConversation(Base):
    ...
    relationship_id = Column(BIGINT, ForeignKey("relationships_network.id"), nullable=True)
    ...
    # FIXED: Updated relationship name
    network_relationship = relationship("NetworkRelationship", back_populates="mj_conversations")
...
class UserLocation(Base):
    ...
    visibility_radius_km = Column(Integer, nullable=True)
